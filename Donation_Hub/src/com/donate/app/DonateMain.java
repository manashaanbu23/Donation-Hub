...
public class DonateMain { 
       public static void main(String[] args) { 
			...
			try { 
				...
				c.setCampaignID("CMP3026C"); 
				c.setCampaignName("Relief uipo Fund 2025"); 
				...
				System.out.println(ok ? "CAMPAIGN CREATED" : "CAMPAIGN CREATION FAILED"); 
			} catch (Exception e) { 
			System.out.println("System Error: " + e.getMessage()); 
			} 
			...
			try { 
				...
				boolean ok = donateService.recordPledge("DNR9001","CMP3026C", pledgeDate, new java.math.BigDecimal("7000.00")); 
